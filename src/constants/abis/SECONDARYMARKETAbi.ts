export const SECONDARY_MARKET_ABI = [
  ...
  { inputs: [], name: "SecondaryMarket__InvalidMaker", type: "error" },
  { inputs: [], name: "SecondaryMarket__InvalidMakerAmount", type: "error" },
  { inputs: [], name: "SecondaryMarket__InvalidMakerToken", type: "error" },
  { inputs: [], name: "SecondaryMarket__InvalidSignature", type: "error" },
  { inputs: [], name: "SecondaryMarket__InvalidTakerAmount", type: "error" },
  { inputs: [], name: "SecondaryMarket__InvalidTakerToken", type: "error" },
  {
